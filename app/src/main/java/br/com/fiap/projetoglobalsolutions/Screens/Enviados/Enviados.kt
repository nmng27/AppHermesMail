package br.com.fiap.projetoglobalsolutions.Screens.Enviados
...
@Composable
fun Enviados(titulo:String, navController: NavController) {
    val context = LocalContext.current
    val emailRepository = EmailRepository(context)
    val lista = emailRepository.listarEnviados("")
